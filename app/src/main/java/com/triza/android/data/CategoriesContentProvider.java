...
public class CategoriesContentProvider extends ContentProvider {
    ...
    public static final int CATEGORIES_WITH_ID = 101;
    ...
    public static UriMatcher buildUriMatcher() {
        ...
        uriMatcher.addURI(CategoriesContract.AUTHORITY, CategoriesContract.PATH_CATEGORIES + "/#", CATEGORIES_WITH_ID);
    ...
    public boolean onCreate() {
        ...
        mCategoriesDbHelper = new CategoriesDbHelper(context);
        return true;
    }
    ...
    public Uri insert(@NonNull Uri uri, ContentValues values) {
        ...
        switch (match) {
            case CATEGORIES:
                ...
                if ( id > 0 ) {
                    returnUri = ContentUris.withAppendedId(CategoriesContract.CategoriesEntry.CONTENT_URI, id);
                } else {
